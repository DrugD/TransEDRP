...
def CTRP_IC50():
    seed_torch(42)
    IC50_dir = "/xxx/v1/v10.D2.avg_pct_viability_data.txt"
    Cell_line_raw_dir = "/xxx/v1/v10.M2.cell_line_info_changeFor_GDSCv2.txt"
    Drug_dir = "/xxx/v1/v10.M1.informer_set.txt"
