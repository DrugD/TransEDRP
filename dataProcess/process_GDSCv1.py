...
def load_drug_smile(drug_dir):
    ...
    reader = csv.reader(open(drug_dir))
    next(reader, None)
    ...
    for item in reader:
        ...
        # print(item)
            ...
            name_temp = ""
            for string_item in item[:-3]:
                name_temp  += string_item
                name_temp  += ","
            name = name_temp[:-1]
            # print(item,'\tchange to :', name)
...
def CTRP_IC50():
    ...
    sh = wb.sheet_by_name(wb._sheet_names[0])

    cell_line_drug_mp = {}
    for i in tqdm(range(1,sh.nrows)):
        
  
        item = dict(zip(sh.row_values(0),sh.row_values(i)))
        key = item['DRUG_NAME'] +'*'+ item['CELL_LINE_NAME']
        cell_line_drug_mp[key] = {}
        cell_line_drug_mp[key]['ic50']= item['LN_IC50']
    ...
    cell_name_dict_re["nci-h2369"] = cell_name_dict_re.pop("h2369")
    cell_name_dict_re["nci-h2795"] = cell_name_dict_re.pop("h2795")
    cell_name_dict_re["nci-h2722"] = cell_name_dict_re.pop("h2722")
    cell_name_dict_re["nci-h2373"] = cell_name_dict_re.pop("h2373")
    cell_name_dict_re["nci-h2731"] = cell_name_dict_re.pop("h2731")
    cell_name_dict_re["nci-h2810"] = cell_name_dict_re.pop("h2810")
    cell_name_dict_re["nci-h513"] = cell_name_dict_re.pop("h513")
    cell_name_dict_re["nci-h2595"] = cell_name_dict_re.pop("h2595")
    cell_name_dict_re["nci-h2461"] = cell_name_dict_re.pop("h2461")
    cell_name_dict_re["nci-h2818"] = cell_name_dict_re.pop("h2818")
    cell_name_dict_re["nci-h2591"] = cell_name_dict_re.pop("h2591")
    cell_name_dict_re["nci-h290"] = cell_name_dict_re.pop("h290")
    cell_name_dict_re["nci-h3118"] = cell_name_dict_re.pop("h3118")
    cell_name_dict_re["nci-h2803"] = cell_name_dict_re.pop("h2803")
    cell_name_dict_re["ntera-2-cl-d1"] = cell_name_dict_re.pop(str.lower("NTERA-S-cl-D1")) 
    cell_name_dict_re["hs-746t"] = cell_name_dict_re.pop(str.lower("Hs746T"))
    cell_name_dict_re["t24"] = cell_name_dict_re.pop(str.lower("T-24"))
    cell_name_dict_re["b-cpap"] = cell_name_dict_re.pop(str.lower("BCPAP"))
    cell_name_dict_re["snu-1"] = cell_name_dict_re.pop(str.lower("NCI-SNU-1"))
    cell_name_dict_re["snu-5"] = cell_name_dict_re.pop(str.lower("NCI-SNU-5"))
    cell_name_dict_re["snu-16"] = cell_name_dict_re.pop(str.lower("NCI-SNU-16"))
    ...
    for key, value in tqdm(cell_line_drug_mp.items()):
        ...
        if cell_name_dict_re.get(cell_line_name) is None:
            miss_cell.append(cell_line_name)
            continue
 
        if drug_dict_lower.get(drug_name) is None:
            miss_drug.append(drug_name)
            continue
